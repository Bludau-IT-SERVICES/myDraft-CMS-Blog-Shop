...
{if $domain_id == 1}
		...
		<div style="float:left;margin-right:30px">
			...
			<ul>
				<li><a title="{$CORE_PLATTFORMNAME} Impressum" href="#">Impressum</a></li>
	...
	<a title="{$CORE_PLATTFORMNAME} RSS-Feed Nachrichten abnonnieren" href="{$domain_name}/mydraft-nachrichten/"><img alt="RSS-Feed" src="/image/rss-small.png"/>RSS-Feed {$CORE_PLATTFORMNAME}</a>
{literal}	
<script>
