...
<HEAD>
	<title>{$page_title}</title>
		...
		<link rel="icon" type="image/png" sizes="32x32" href="/templates/myd-bludau-media/media/favicon-32x32.png">
		<link rel="icon" type="image/png" sizes="96x96" href="/templates/myd-bludau-media/media/favicon-96x96.png">
		<link rel="icon" type="image/png" sizes="16x16" href="/templates/myd-bludau-media/media/favicon-16x16.png">
		<link rel="stylesheet" href="/framework/animate.css/animate.min.css">
		<link href="/templates/myd-bludau-media/css/flexnav.css" rel="stylesheet" type="text/css" />
