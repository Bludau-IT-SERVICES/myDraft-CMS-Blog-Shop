 ...
 */
const CLIENT_ID = '778239151304-fpb4po45r0qmc6goahevm7v5v9e3noup.apps.googleusercontent.com';

/**
 * Replace this with the client secret you got from the Google APIs console.
 */
const CLIENT_SECRET = '8BceCCAjGpqP7ysTznGUXkls';

/**
 * Optionally replace this with your application's name.
 */
const APPLICATION_NAME = "Shopste.com Marktplatz";
