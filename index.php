...
# INSTALL-PATH
#define("CORE_INSTALL_PATH","/var/www/vhosts/bludau.io/cms-mydraft.bludau.io/");
...
include_once(CORE_INSTALL_PATH.'include/inc_basic-functions.php');

# LAYOUTING STUFF for modules
include_once(CORE_INSTALL_PATH.'include/inc_buildbox.php');

# OPTIONAL: BASKET CASE 
include_once(CORE_INSTALL_PATH.'cart/cart_info.php');	
...
if(!empty($_GET['suche'])) $_SESSION['suchtext'] = $_GET['suche'];
...
if($core_domain_info_ary['name'] == '') {
	...
	$mydraft->displayCMSPage('error_pages/no_domain_found.tpl','no_domainname_found','false');
