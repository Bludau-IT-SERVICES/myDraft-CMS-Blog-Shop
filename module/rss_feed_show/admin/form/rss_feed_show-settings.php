...
if(isset($_POST['optModul'])) {
	...
	if($_POST['modus'] == 'new') {
		...
		$query = "INSERT INTO `modul_".$_POST['optModul']."` (`title_de`, `menue_id`, `last_usr`,rss_quelle) VALUES ('".$_POST['module_title']."', ".$_SESSION['page_id'].", 0,'".$_POST['module_feed_quelle']."');";
		...
		$query = "UPDATE `modul_".$_POST['optModul']."` SET title_de='".$_POST['module_title']."',menue_id='".$_POST['module_menue_id']."',rss_quelle='".$_POST['module_feed_quelle']."' WHERE id='".$_POST['module_id']."'";
	  ...
	  <p>		
			<form name="frmModulAdd" id="module_ajax_save_form" action="/module/<?= $_GET['module_name'].'/admin/form/'.$_GET['module_name'].'-settings.php'; ?>" method="POST" onSubmit="return module_save_form('module_ajax_save_form');">
				<div class="label" style="float:left;">
					<input type="hidden" id="acp_get_modul_name" name="optModul" value="rss_feed_show"/>
				...
				<div style="clear:both"></div>	
				<div class="label" style="float:left;">RSS-Feed Quelle:</div>
				<div id="module_title">
					<input type="text" name="module_feed_quelle" value="<?php echo $dataMenue['rss_quelle']; ?>">
				</div>
				<div style="clear:both"></div>					
			<?php 
				if($_GET['modus'] == 'edit') {											
