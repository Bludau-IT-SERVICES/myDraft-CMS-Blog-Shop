...
if(isset($_POST['optModul'])) {
	...
	if($_POST['modus'] == 'new') {
		...
		$query = "INSERT INTO `modul_".$_POST['optModul']."` (`title_de`, `menue_id`, `last_usr`,shop_cat_id,item_count) VALUES ('".$_POST['module_title']."', ".$_COOKIE['last_page'].", 0,'".$_POST['opt_shop_cat_id']."','".$_POST['module_item_count']."');";
		...
		$query = "UPDATE `modul_".$_POST['optModul']."` SET title_de='".$_POST['module_title']."',shop_cat_id='".$_POST['opt_shop_cat_id']."',menue_id='".$_POST['module_menue_id']."',item_count='".$_POST['module_item_count']."' WHERE id='".$_POST['module_id']."'";
...
<?php 
	if($_GET['modus'] == 'new') {
		echo '<h2>Neues Shop neuste Artikel Modul <strong>hinzuf&uuml;gen</strong></h2>';
		require('../../../../include/inc_config-data.php');
	...
	if($_GET['modus'] == 'edit') {
		require('../../../../include/inc_config-data.php');
		echo '<h3>Shop neuste ArtikelModul <strong>editieren</strong></h3>';
	  ...
	  <p>		
			<form name="frmModulAdd" id="module_ajax_save_form" action="/module/<?= $_GET['module_name'].'/admin/form/'.$_GET['module_name'].'-settings.php'; ?>" method="POST" onSubmit="return module_save_form('module_ajax_save_form');">
				<div class="label" style="float:left;">
					<input type="hidden" id="acp_get_modul_name" name="optModul" value="shop_cat_neuste"/>
				...
				<div style="clear:both"></div>		
				<div class="label" style="float:left;">Anzahl der Artikel</div>
				<div id="module_title">
					<input type="text" name="module_item_count" value="<?php echo $dataMenue['item_count']; ?>">
				</div>
				<div style="clear:both"></div>						
			<?php 
				if($_GET['modus'] == 'edit') {											
			...
			?>
				...
				<div id="module_submit">
					<input type="submit" class="module_form_submit" id="module_form_submit" name="module_submit" value="<?php echo $strButtonName; ?>">
				</div>		
			</form>
	  </p>
</div>	  
