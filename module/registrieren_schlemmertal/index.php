...
# >> TEXTHTML Modul 
####################################
function LoadModul_registrieren_schlemmertal($config) {

		$dataTextHTML = mysqli_fetch_array(DBi::$conn->query("SELECT * FROM modul_registrieren_schlemmertal WHERE id=".$config['modul_id']));
		...
		$dataTextHTML['typ'] = 'registrieren_schlemmertal';
